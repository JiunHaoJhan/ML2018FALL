...
def get_optimizer(params):
    ...
    """
    #res
    optimizer = torch.optim.SGD(params, lr=0.1, weight_decay=0.001)
    #mob
...
def before_batch(train_history, validation_history):
    ...
    return {"optimizer": {"lr": lr_rate}, "batch_norm": 0.5, "drop_out":None}
...
def save_model_as(train_history, validation_history):
    ...
    if (n_epoch-1) == max_epoch:
        return str(n_epoch-1) +'_save_res.pth.tar'
    else:
        return None
